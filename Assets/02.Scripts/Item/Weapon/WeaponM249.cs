...
using UnityEngine;
/// <summary>
/// This is M249 Weapon class 
/// </summary>
public class WeaponM249 : MonoBehaviour,ImWeapon
{

    #region ID

    public int EntityID { get; set; } = 4;
    ...
    public float ShakeDuration { get; } = 0.06f;

    public float ShakeMagnitudePos { get; } = 0.04f;
